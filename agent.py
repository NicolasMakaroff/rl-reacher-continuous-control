...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.actor_local.load_state_dict(torch.load('ddpg_actor.pth'))  # use stored weights
        self.actor_target.load_state_dict(torch.load('ddpg_actor.pth')) # use stored weights
        ...
        self.critic_local.load_state_dict(torch.load('ddpg_critic.pth'))
        self.critic_target.load_state_dict(torch.load('ddpg_critic.pth'))
